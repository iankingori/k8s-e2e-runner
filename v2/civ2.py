...
def parse_args():
    ...
    p.add('--collect-logs-windows-yaml', default="https://raw.githubusercontent.com/CristianHenzel/k8s-e2e-runner/collect-logs/v2/collect-logs-windows.yaml")
    p.add('--collect-logs-windows-script', default="https://raw.githubusercontent.com/CristianHenzel/k8s-e2e-runner/collect-logs/v2/collect-logs.ps1")
    p.add('--collect-logs-linux-yaml', default="https://raw.githubusercontent.com/CristianHenzel/k8s-e2e-runner/collect-logs/v2/collect-logs-linux.yaml")
    p.add('--collect-logs-linux-script', default="https://raw.githubusercontent.com/CristianHenzel/k8s-e2e-runner/collect-logs/v2/collect-logs.sh")
